...
export const technologies: TechnologyGroup[] = [
 ...
 {name:'Spatial interfaces',level:'Demonstrated in this portfolio',items:['Three.js','React Three Fiber','WebGL']},
 ...
 {name:'Extended technology map',level:'Owner-requested scope · project evidence pending',items:['PostgreSQL','MongoDB','Redis','Linux','GitLab CI/CD','Self-hosted infrastructure','Vite','Electron','Django REST Framework','React Native','Expo','MediaPipe','LLM applications','AI tooling']},
];
